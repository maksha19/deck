            ...
            <div className="max-w-6xl w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div className="glass-card p-4 md:p-6 animate-fade-in-up stagger-1">
                        <h3 className="text-base md:text-xl font-semibold text-white mb-4 flex items-center gap-2">
                        ...
                        <div className="space-y-3">
                            {quantitative.map((item, index) => (
                                <div key={index} className="border-b border-white/10 pb-3 md:pb-4 last:border-0 last:pb-0">
                                    ...
                                    <p className="text-green-400 font-bold text-base md:text-xl">{item.threshold}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="glass-card p-4 md:p-6 animate-fade-in-up stagger-2">
                        ...
                        <ul className="space-y-2 md:space-y-3">
                            {qualitative.map((item, index) => (
                                <li key={index} className="flex items-start gap-2 md:gap-3 text-white/80 text-[11px] md:text-lg leading-relaxed">
